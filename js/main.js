        ...
        var filterTrails = $.getJSON("https://sgrandstrand.carto.com/api/v2/sql?format=GeoJSON&q=" + sql, function (data) {
            trails = L.geoJson(data, {
                onEachFeature: function (feature, layer) {
                    ...
                    layer.bindPopup('<p><b>' + feature.properties.trllabel + '</b><br/><em>' + 'Trail Distance: ' + feature.properties.miles + '<br/><em>'+ 'Trail Usage: ' + feature.properties.trluse + '<br/><em>' + 'Reviews: ' + feature.properties.user_date + ': ' + feature.properties.review + '</p>');
